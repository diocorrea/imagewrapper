 ...
 */
package com.newsnow.imagewrapper.repository.generated.tables;


import com.newsnow.imagewrapper.repository.generated.Keys;
import com.newsnow.imagewrapper.repository.generated.Public;
...
public class Task extends TableImpl<TaskRecord> {
    ...
    /**
     * The column <code>public.task.md5</code>.
     */
    public final TableField<TaskRecord, String> MD5 = createField(DSL.name("md5"), SQLDataType.VARCHAR(50).nullable(false), this, "");
     ...
     */
    public final TableField<TaskRecord, Integer> WIDTH = createField(DSL.name("width"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.task.height</code>.
     */
    public final TableField<TaskRecord, Integer> HEIGHT = createField(DSL.name("height"), SQLDataType.INTEGER, this, "");
